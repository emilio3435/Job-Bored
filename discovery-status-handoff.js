    ...
    case "polling_error":
      statusMessage =
        state.pollErrorCount >= MAX_POLL_ERRORS
          ? "Discovery started — we stopped getting updates. New roles will still land in your Pipeline; check Runs in a few minutes."
...
/**
 * UX01 C9 (FD-12): "Found N new · View" lands on the Pipeline. Lane C owns
 * the views; until it publishes a view API this scrolls the board in.
 */
