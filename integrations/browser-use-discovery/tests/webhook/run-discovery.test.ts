...
test("runDiscovery serpapi_google_jobs lane writes only allowlisted companies", async () => {
          ...
          jobs_results: [
            {
              ...
              apply_options: [
                {
                  title: "Apply on SmartRecruiters",
                  link: "https://jobs.smartrecruiters.com/Notion/111",
                },
              ],
            ...
            },
            {
              ...
              apply_options: [
                {
                  title: "Apply",
                  link: "https://jobs.smartrecruiters.com/Figma/abcd",
                },
              ],
            },
          ],
  ...
  const dependencies = {
    ...
    loadStoredWorkerConfig: async (sheetId: string) => ({
      ...
      mode: "hosted",
      timezone: "UTC",
      companies: [{ name: "Notion", domains: ["jobs.smartrecruiters.com"] }],
      includeKeywords: [],
      excludeKeywords: [],
      targetRoles: ["Backend Engineer"],
      locations: ["Remote"],
    ...
    mergeDiscoveryConfig: (stored: Record<string, unknown>, request: Record<string, unknown>) => ({
      ...
      allowlistResolution: {
        mode: "restricted",
        matched: ["jobs.smartrecruiters.com"],
        unknown: [],
      },
  ...
  const request = {
    ...
    companyAllowlist: ["jobs.smartrecruiters.com"],
    discoveryProfile: {
      targetRoles: "Backend Engineer",
      locations: "Remote",
      remotePolicy: "remote",
