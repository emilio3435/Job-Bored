...
(function () {
  ...
  const FIELD_TAB_MAP = Object.freeze({
    ...
    settingsDiscoveryTargetRoles: SETTINGS_TAB_IDS.PROFILE,
    settingsDiscoveryLocations: SETTINGS_TAB_IDS.PROFILE,
    settingsDiscoveryRemotePolicy: SETTINGS_TAB_IDS.PROFILE,
    settingsDiscoverySeniority: SETTINGS_TAB_IDS.PROFILE,
    settingsDiscoveryKeywordsInclude: SETTINGS_TAB_IDS.DISCOVERY,
    settingsDiscoveryKeywordsExclude: SETTINGS_TAB_IDS.PROFILE,
    ...
    settingsProfileFormKeywordsExclude: SETTINGS_TAB_IDS.PROFILE,
    ...
    settingsProfileRefreshBtn: SETTINGS_TAB_IDS.PROFILE,
    settingsProfileSpinner: SETTINGS_TAB_IDS.PROFILE,
    settingsProfileStatus: SETTINGS_TAB_IDS.PROFILE,
    settingsProfileAutoRefreshToggle: SETTINGS_TAB_IDS.PROFILE,
    settingsProfileAutoRefreshCadence: SETTINGS_TAB_IDS.PROFILE,
    settingsProfileAutoRefreshHint: SETTINGS_TAB_IDS.PROFILE,
    // Profile → Schedule card (three-tier daily-refresh ladder)
    settingsProfileScheduleLocalEnable: SETTINGS_TAB_IDS.PROFILE,
    settingsProfileScheduleLocalTime: SETTINGS_TAB_IDS.PROFILE,
    settingsProfileScheduleLocalOsHint: SETTINGS_TAB_IDS.PROFILE,
    settingsProfileScheduleLocalCommand: SETTINGS_TAB_IDS.PROFILE,
    settingsProfileScheduleLocalCopyInstall: SETTINGS_TAB_IDS.PROFILE,
    settingsProfileScheduleLocalCopyUninstall: SETTINGS_TAB_IDS.PROFILE,
    settingsProfileScheduleLocalBadge: SETTINGS_TAB_IDS.PROFILE,
    settingsProfileScheduleLocalArtifact: SETTINGS_TAB_IDS.PROFILE,
    settingsProfileScheduleLocalError: SETTINGS_TAB_IDS.PROFILE,
    settingsProfileScheduleCloudEnable: SETTINGS_TAB_IDS.PROFILE,
    settingsProfileScheduleCloudTime: SETTINGS_TAB_IDS.PROFILE,
    settingsProfileScheduleCloudLocalPreview: SETTINGS_TAB_IDS.PROFILE,
    settingsProfileScheduleCloudDownload: SETTINGS_TAB_IDS.PROFILE,
    settingsProfileScheduleCloudBadge: SETTINGS_TAB_IDS.PROFILE,
    settingsProfileScheduleCloudError: SETTINGS_TAB_IDS.PROFILE,
