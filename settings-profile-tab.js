...
(function () {
  ...
  var GITHUB_ACTIONS_TEMPLATE = [
    ...
    "# The Cloudflare relay is not a GitHub Actions target: this job refuses a relay",
    "# webhook URL with a migration note instead of failing silently.",
    "",
