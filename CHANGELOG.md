...
- **ATS-native scraping** — Greenhouse, Lever, Ashby, SmartRecruiters, and Workday job URLs are read from each board's public JSON API before HTML. Closed Greenhouse jobs that redirect to a careers listing no longer get stored as the JD.
