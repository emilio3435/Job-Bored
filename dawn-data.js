...
(function (root) {
  ...
  function getRoleViewModel(jobKey, opts) {
    ...
    var EMPTY_JOB = {
      ...
      postedAt: "", closesAt: "", postingSalary: "",
    ...
    return {
      job: {
        ...
        salary: rec.salary,
        tags: mergedTags,
        postedAt: String(_attr(card, "data-posted-at") || "").trim(),
        closesAt: String(_attr(card, "data-closes-at") || "").trim(),
        postingSalary: String(_attr(card, "data-posting-salary") || "").trim(),
